...
🗺️ Geographic sales distribution across India
🏙️ Top-performing cities and quarterly business summaries
🎯 Key Metrics (KPIs)
💰 Total Sales: ₹53M
⭐ Average Rating: 4.34
...
🔍 Features
🎚️ Interactive slicers — filter by Month, Category, and Restaurant Name across the entire report
🧭 Custom page navigation — button-based navigation between Dashboard and Analysis pages
🌡️ Conditional formatting (heat map) — quarterly performance table with color-coded Sales, Rating, and Orders
🗺️ Geographic visualization — filled map showing sales intensity across Indian states
...
📷 Screenshots
👉 ![Dashboard Preview](Pan-India%20Food%20Delivery%20Sales%20Intelligence%20Dashboar.png)
